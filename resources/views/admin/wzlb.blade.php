            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        @foreach($data as $lis)
                            <tr class="gradeX">
                                <td class="center">{{ $lis->ar_id }}</td>
                                <td>{{ $lis->dh_Navigationbar }}</td>
                                <td>{{ $lis->ar_title }}</td>
                                <td class="center" style="color:{{ $lis->ar_status==1?'red':'#646464' }};">{{ $lis->ar_status==1?'顶':'否' }}</td>
                                <td class="center">
                                    <a href="/admin/wzmodify{{ $lis->ar_id }}">编辑</a>  |
                                    <a href="/admin/wzde/{{ $lis->ar_id}}" >删除</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
