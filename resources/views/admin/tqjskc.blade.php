                            ...
                            <tr class="gradeX">
                                ...
                                <td>
                                    @if($l->ht_zgsh == '4'|| $l->ht_zgsh == null)
                                        <select name="" id="" onchange="shenhe(this,{{ $l->jl_id }},{{ $l->t_id }},{{ $l->rid }},1,0,{{ $l->id }})">
                                ...
                                <td>
                                    @if($l->ht_zgsh == '4'|| $l->ht_zgsh == null)
                                        <select name="" id="jc{{ $l->jl_id }}" disabled="true" onchange="shenhes(this,{{ $l->jl_id }},{{ $l->t_id }},{{ $l->rid }},2,0,{{ $l->id }})">
...
<script>
    ...
    function shenhe(value,id,tid,rid,zt,edit,oid){
        ...
        if(item.value == '1'){
            $.post('/admin/tdye.html',{"id":id,"tid":tid,'rid':rid,'zt':zt,'m':money,'edit':'1','pd':'tqjskc','oid':oid},function(){
                location.reload();
            })
        }else if(item.value == '2'){
            $.post('/admin/tdye.html',{"id":id,"tid":tid,'rid':rid,'zt':zt,'m':money,'edit':'2','pd':'tqjskc','oid':oid},function(){
                location.reload();
            })
        }else if(item.value == '3'){
            $.post('/admin/tdye.html',{"id":id,"tid":tid,'rid':rid,'zt':zt,'m':money,'edit':'3','pd':'tqjskc','oid':oid},function(){
                location.reload();
            })
        }
    }
    ...
    function shenhes(value,id,tid,rid,zt,edit,oid){
        ...
        if(item.value == '1'){
            ...
            $.post('/admin/tdye.html',{"id":id,"tid":tid,'rid':rid,'zt':zt,'m':money,'edit':'4','pd':'tqjskc','oid':oid},function(){
                location.reload();
            })
        }
    }
