                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr valign="top" align="center">
                            ...
                            <td>
                                <div>
                                    <p>预约时间:<input type="text" name="" value="{{ $re->jd_times }}"></p>
                                    ...
                                    <p>最近登录:<input type="text" name="" value="{{ $re->tc_dltimes }}"></p>
                                    <p>注册时间:<input type="text" name="" value="{{ $re->tc_reg_date }}"></p>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <p>教员编号:<input type="text" name="" value="{{ $re->id }}"></p>
                                    <p>姓名:<input type="text" name="" value="{{ $re->tc_name }}"></p>
                                    <p>籍贯:<input type="text" name="" value="{{ $re->tc_jiguan }}"></p>
                                    <p>性别:<input type="text" name="" value="{{ $re->tc_sex=='1'?'男':'女' }}"></p>
                            ...
                            <td>
                                <div>
                                    ...
                                    <p><a href="http://wpa.qq.com/msgrd?v=3&uin={{ $re->tc_qq }}&site={{ $re->tc_qq }}&menu=yes">QQ交谈</a></p>
                                </div>
                            </td>
                            <td>
                                <div>
                                ...
                                <div>
                                    ...
                                    <form action="/admin/orderxgjyzt" method="post">
                                        ...
                                        <select name="ht_t_status">
                                            ...
                                            <option value="3" @if($re->ht_t_status == '3') selected='selected' @endif>已审核</option>
                                            <option value="4" @if($re->ht_t_status == '4') selected='selected' @endif>取消预约</option>
                                            <option value="5" @if($re->ht_t_status == '5') selected='selected' @endif>已确认</option>
                                            <option value="6" @if($re->ht_t_status == '6') selected='selected' @endif>部分合适</option>
                                            <option value="7" @if($re->ht_t_status == '7') selected='selected' @endif>试课中</option>
                                            <option value="8" @if($re->ht_t_status == '8') selected='selected' @endif>已成功(授课中)</option>
