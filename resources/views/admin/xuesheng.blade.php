                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        @foreach($list as $lis)
                            <tr class="gradeX">
                                ...
                                <td>{{ $lis->city_name }}</td>
                                <td class="center">
                                    @if($lis->tc_sort == 1 && $lis->tc_jinpai == 2)
                                        前台显示
                                    @else
                                        前台没显示
                                    @endif
                                ...
                                <td class="center">
                                    ...
                                    @if($lis->tc_sort == 1)
                                        <a href="/admin/do_xue_sheng/{{ $lis->id }}/0" class="glyphicon glyphicon-ok">取消</a>
                                    @else
                                        <a href="/admin/do_xue_sheng/{{ $lis->id }}/1" class="glyphicon glyphicon-remove">设置显示</a>
                                    @endif
