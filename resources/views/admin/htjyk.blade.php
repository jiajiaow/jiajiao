                        ...
                        @foreach($data as $re)
                            ...
                            <td>
                                <div>
                                    ...
                                    <p>最近登录：{{ date('Y-m-d G:i:s',$re->tc_dltimes) }}</p>
                            ...
                            <td style="width: 100px;">
                                <div>
                                    ...
                                    <p>性别：<input type="text" value="@if($re->tc_sex=='1')男@elseif($re->tc_sex=='0')女@elseif($re->tc_sex=='')@endif"></p>
                            ...
                            <td>
                                ...
                                <span style="display: none;">
                                    {{ $re->id }}{{ $re->tc_reg_date }}{{ date('Y-m-d h:i:s',$re->tc_dltimes) }}{{ $re->tc_citys }}{{ $re->tc_shu }}{{ $re->tc_han }}{{ $re->tc_name }}{{ $re->tc_jiguan }}{{ $re->tc_sex=='1'?'男':'女' }}{{ $re->tc_type }}{{ $re->tc_subjects }} {{ $re->tc_school }}{{ $re->tc_nj }}{{ $re->tc_zhuanye }}{{ $re->tc_type }}{{ $re->tc_jl }}{{ $re->tc_class }}{{ $re->tc_hight }}{{ $re->tc_phone }}{{ $re->tc_email }} {{ $re->tc_wechat }} {{ $re->tc_qq }}{{ $re->tc_phone_bak }}{{ $re->tc_certificate }}{{ $re->tc_comments }}{{ $re->tc_case }}
                                </span>
                            </td>
                        </tr>
                        @endforeach
