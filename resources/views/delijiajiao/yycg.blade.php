...
@section('title',session('regionname')-'预约成功')
@section('content')
<div class="container">
  <div class="zfsm" style="height:500px;">
      <div class="nr"><br><br>
       ...
       <h3 style="text-align: center;padding:40px;">联系电话：<span style="color: #ff0000;">400-8080-740</span><span style="padding:40px;">|</span>微信：<span style="color: #ff0000;">delijiajiao</span></h3></div>
