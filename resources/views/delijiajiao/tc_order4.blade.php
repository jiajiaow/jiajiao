					...
					<div class="bk">
						...
						<div class="right">
							<form action="/tc_skadd.html" method="post">
								...
								<input name="add" id="jy_adres" type="text" style="height: 29px;"  value="{{ $skzs->radd }}"/>
