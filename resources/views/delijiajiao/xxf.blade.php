...
<body style="background-color:#F1F1F1">
	...
	<div id="zhen_container">
		<!--支付界面 -->
		<form action="" method="post" id="xxf">
		<div class="zfjm">
			<div class="zfjm-c">
				<!-- 第一部分 -->
				<div class="ddh">
				...
				<div class="ddh-one">
					<div class='d-h'>
						<label>类别：</label>
						<span id='xx' class='d-active'>信息费</span>
<!-- 						<span id='cy'>诚意金</span>
						<span id='cz' >充值</span> -->
					</div>
					<!--  -->
					<div id="xxx" style="display:block">
						<div>
						...
						<div class="d-h" id='caozz'>
							...
							<input readonly="readonly" type="hidden" class="d-jine" name="tid" value="{{ $data['tid'] }}">
							@if(!empty($data['b']))
...
<!-- 					<div id="czz">
				...
				<div class="ddh-four">
					...
					<input class="cz-5" type="button" onclick="zf()" value="立即支付">
				</div>
			</div>
		</div>
		</form>
...
//		$('#cnmm').text('费用'+a+'元');
	...
	<style>
		.ac_tive{
			border:1px solid rgb(250, 204, 64);
		}
	</style>
</body>
</html>
