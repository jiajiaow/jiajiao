	...
	<form method="post" action="/doxy_hetong">
		<div class="wrap">
			<div class="content-top">
				...
				<p style="text-indent: 35px;">兹安排德栗家教教员，姓名：{{ $list->tc_name }} 编号：T{{ $list->t_id }} 学校: {{ $list->tc_school }}（{{ $list->tc_type }}） {{--（ 如是专职老师或其他老师,显示专职老师/其他老师）--}}电话：{{ $list->tc_phone }}上门为您试课，试课当天教员也将带身份证、学生证上门，请进行确认，如您对老师满意，确认其以后继续为孩子授课，试课课酬便按照上课标准给到老师，如果您对老师并不是特别满意，您将无需支付任何费用，免费上课，并且我们将免费为您安排其他老师上门试课。</p>
				<p style="text-align: center">德栗家教</p>
				<p style="text-align: center">{{ date('Y-m-d h:i:s',$list->jd_times) }}</p>
			</div>
			<div class="content-mid">
				...
				<p>　<span class="text_1">@if($list->xy_qz == '1') 甲方已签认 @else甲方（签字）@endif</span>：<button class="btn btn_1">签认按钮</button> <span class="text_2">乙方签字</span>：<span class=" btn_2">已签认</span>  <span class="text_3">@if($list->jy_qz == '1') 丙方已签认 @else丙方（签字）@endif</span>：<span class="btn btn_3">签认按钮</span></p>
