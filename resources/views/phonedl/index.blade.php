    ...
    <div class="wrap" id="app">
        <header class="jj_header">
            <div class="jj_header_left">
                ...
                <div class="jjh_text_box">
                    <span class="jjh_text_jj">德栗家教</span> {{--德栗家教--}}
            ...
            <div class="jj_header_right">
                ...
                <span class="header_city"><span class="header_city_text" onclick="javascript:window.location.href='/change_citydlsj.html'">{{ substr(session('cityname'),0,6) }}</span> <img src="/phone/img/xl.png" style="margin-top: .1rem;width:.4rem;" ></span>
            </div>
        </header>
        ...
        <section class="msg_box">
            ...
            <div class="school_box_content">
                <ul>
                    @foreach($xx as $xx)
                        <li><a href="/mobile/hot.html/学院/{{ $xx->school_name }}">{{ $xx->school_name }}</a></li>
                    @endforeach
                </ul>
            </div>
        </section>
        ...
        <section class="msg_box">
            ...
            <div class="msg_box_tab_content">
                <ul>
                    ...
                    <a href="/mobile/xsinfo{{ $data->id }}.html" style="color:#000;"><li class="el_tab_content">
