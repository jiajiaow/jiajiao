...
<div class="wrap" id="app">
    ...
    <div class="teacher_business">
        ...
        <div class="teacher_msg">
            <span><i class="teacher_school_icon"></i>{{ $list->tc_school }}</span>
            <span style="margin-left: .2rem"><i class="teacher_edu_icon"></i>@if($list->tc_zhuanye == '--请选择--')@else{{ $list->tc_zhuanye }} @endif</span>
        </div>
        </p>
            ...
            <el-tab-pane label="个人资料" name="first">
                <div class="grzl_box">
                    ...
                    <ul>
                        <li>
                            <p>平时所在城市</p>
                            <p>{{ $list->tc_citys=='--请选择--'?'':$list->tc_citys }}</p>
                        </li>
                        <li>
                            <p>暑假所在城市</p>
                            <p>{{ $list->tc_shu=='--请选择--'?'':$list->tc_shu }}</p>
                        </li>
                        <li>
                            <p>寒假所在城市</p>
                            <p>{{ $list->tc_han=='--请选择--'?'':$list->tc_han }}</p>
                        </li>
                    </ul>
                </div>
            </el-tab-pane>
