...
<head>
	...
	<title>手机登录</title>
	<link rel="stylesheet" href="css/sjdl.css">
...
<body>
	<header>
		<div>
			<img src="images/bg.png" alt="" width="100%" class="lc-bg">
			<!-- 触摸跳转 -->
			<img src="images/x.png" alt="" width="100%" class="lc-x" >
		...
		<div class="dl3-container">
			...
			<form action="" id="form1">
				<div class="ye1" style="margin-top: .6rem;height: 1.2rem"> 
					<img src="images/photo.png" alt="" class="img1" style="top: 4rem;left: 2.2rem">
					<input type="text" name="" placeholder="请输入账号/手机号" class="zzzzz" maxlength="11">
				</div>
				<div class="ye1" style="height: 1.2rem">
					<img src="images/suo.png" alt="" class="img2" style="top: 5.7rem;left: 2.2rem">
			...
			<form action="" method="POST" id="form" style="display: none;">
				<div class="ye1" style="margin-top:.6rem">
					<!-- <i></i> -->
					<img src="images/photo.png" alt="" class="img1" style="left: 2.2rem;top:4rem">
					<input type="text" name="" placeholder="请输入账号/手机号" class="zzzzz" maxlength="11">
				</div>
				<div class="ye1">
					<img src="images/suo.png" alt="" class="img2" style="top:5.7rem;left: 2.2rem">
