	...
	<div class="container">
		<div class="teach-left">
			<div class="teach-img">
				...
				<span><i>{{ substr($list->tc_name,0,3) }}教员</i>编号：T{{ $list->id }}</span>
					<span href="" class="btn fx"><img src="{{ asset('/home/picture/icon_share.png') }}" alt="">分享老师名片
						<div class="share">
							<a title="转发至QQ空间" charset="400-03-8" id="s_qq"
							   href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=" target="_blank">
								        <img  src="{{ asset('/home/picture/ico_qzone.png') }}" />
								    </a>
					...
					<a href="javascript:writeCookie({{ $list->id }});" class="btn jr"><img src="{{ asset('/home/picture/icon_plus.png') }}" alt="">加入备选老师</a>
					<div class="clear"></div>
					<!--金牌教员-->
				...
				<div class="teach-info">
					...
					<dl style='width:100%'>
						<dt>学　　校：</dt>
						<dd class='qw'>{{ $list->tc_school }}<input type="" /></dd>
					</dl>
					<dl style='width:100%'>
						<dt>专业类别：</dt>
						<dd class='qw'>{{ $list->tc_zhuanye }}<input type="" /></dd>
					</dl>
					<dl style='width:100%'>
						<dt>具体专业：</dt>
						<dd class='qw'>{{ $list->tc_spl }}<input type="" /></dd>
					</dl>
					<dl style='width:100%'>
						<dt>性　　别：</dt>
						<dd class='qw'>{{ $list->tc_sex='1'?'男':'女' }}<input type="" /></dd>
					</dl>
					<dl style='width:100%'>
						<dt>籍　　贯：</dt>
						<dd class='qw'>{{ $list->tc_jiguan }}<input type="" /></dd>
					</dl>
					<dl style='width:100%'>
						<dt>年　　级：</dt>
						<dd class='qw'>{{ $list->tc_nj}}<input type="" /></dd>
					</dl>
					<dl style='width:100%'>
						<dt>教　　龄：</dt>
						<dd class='qw'>{{ $list->tc_jl }}<input type="" /></dd>
					</dl>
					<dl style='width:100%'>
						<dt>教师性质：</dt>
						<dd>
				...
				<form action="{{ asset('/home//xueyuan/xuqiu_ok.php') }}" method="post" onsubmit="return checkSubmit(1);">
					<div class="fg">
						<label for="">联系人</label>
	...
	<div id="content">
		<div class="container">
			<div class="detial-tab">
				...
				<div class="link-cont">
					<div class="page">
						<h3><img src="{{ asset('/home/picture/icon_teach.png') }}" alt="">可授课情况</h3>
						<div class="inner-cont">
							<dl style='width:100%'>
								...
								<dd>
									...
									<textarea cols="80" rows="5">{{ substr($list->tc_subjects,1,800) }}</textarea>
								</dd>
							</dl>
							<dl style='width:100%'>
								<dt>授课区域：</dt>
								<dd>
									<textarea cols="80" rows="5">{{ substr($list->tc_area,1,800) }}</textarea>
								</dd>
							</dl>
							<dl style='width:100%'>
								<dt>可授课时间：</dt>
								<dd>
									<textarea cols="80" rows="5">{{ $list->tc_sktime }}</textarea>
								</dd>
							</dl>
							<dl style='width:100%'>
								<dt>课酬要求：</dt>
								<dd>
									<i>@if($list->tc_salary == null)
										执行德栗家教收费标准
										@else
										{{ $list->tc_salary }}
										@endif
									</i>
									<a href=""><img src="{{ asset('/home/picture/icon_doubt.png') }}" alt="">查看家教标准</a>
								</dd>
							</dl>
					...
					<div class="page">
						...
						<h3><img src="{{ asset('/home/picture/icon_anli.png') }}" alt="">个人资料</h3>
						<div class="inner-cont">
							<dl class="last">
								<dt>自我评价：</dt>
								<dd>{{ $list->tc_comments }}</dd>
							</dl>
							<dl style='width:100%'>
								<dt>所获证书：</dt>
								<dd>{{ $list->tc_certificate }}</dd>
							</dl>
					...
					<div class="page">
						...
						<h3>
							<img src="{{ asset('/home/picture/icon_jilu.png') }}" alt="">家教经验
						</h3>
