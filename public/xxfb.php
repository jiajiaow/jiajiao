...
<head>
    <meta charset="UTF-8">
    <title><?php echo $_GET['title'];?>【<?php echo $_SERVER["HTTP_HOST"];?>】专业大学生上门辅导</title>
</head>
<style>
...
<body>
    <div style="width: 60%;margin: 0 auto;">
        <h2>德栗家教【<a target="_blank" href="/xsinfo<?php echo $_GET['oid'];?>.html" ><?php echo $_SERVER["HTTP_HOST"];?></a>】专业大学生上门辅导</h2>
        <span>家教编号:T<?php echo $_GET['oid'];?></span><br>
        <span>学员年级：<span><?php echo $_GET['nj']; ?></span></span><br>
        <span>辅导科目：<span><?php echo $_GET['fdkm']; ?></span></span><br>
        ...
        <a href="/xsinfo<?php echo $_GET['oid'];?>.html"><?php echo $_SERVER["HTTP_HOST"];?>/xsinfo<?php echo $_GET['oid'];?>.html</a>
