$._cityInfo = [{"n":"北京市","c":["北京市"]},  {"n":"北京市","c":["北京市"]},
...
$.initProv = function(prov, city, defaultProv, defaultCity) {  
    ...
    for(var i = 1; i < $._cityInfo.length; i++) {
        ...
        provHtml += '<option value="' + i + '"' + ((hasDefaultProv && i == defaultProv) ? ' selected="selected"' : '') + '>' + $._cityInfo[i].n + '</option>';
...
$.initCities = function(provEl, cityEl, defaultCity) {  
    ...
    if(provEl.val() != '' && parseInt(provEl.val()) >= 0) {  
        ...
        for(var i = 0; i < cities.length; i++) {  
            ...
            cityHtml += '<option value="' + cities[i] + '"' + ((hasDefaultCity && i == defaultCity) ? ' selected="selected"' : '') + '>' + cities[i] + '</option>';
