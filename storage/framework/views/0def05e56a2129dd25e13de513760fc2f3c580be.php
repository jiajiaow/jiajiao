	...
	<form method="post" action="/dohetong">
		<div class="wrap">
			...
			<div class="content-mid">
				...
				<p>一、乙方教员自动抓取为甲方提供每周<input type="text" name="o_ts" value="<?php echo e($list->o_ts); ?>" class="inwidth">次，每次<input type="text" name="o_xs" value="<?php echo e($list->o_xs); ?>"  class="inwidth">小时的家教辅导；约定授课周期为<input type="text" name="o_yue" value="<?php echo e($list->o_yue); ?>" class="inwidth">月。</p>
				<p>二、甲方按课时付给乙方<input type="text" name="money" value="<?php echo e($list->money); ?>" class="inwidth">元／时，按每周结算。课程反馈是上课内容中非常重要的一环，有利于家长学员更清晰的了解上课内容，以及根据学员情况针对性的确定下次课程的内容，所以如丙方未完成课程反馈，甲方暂时无须支付。</p>
				<p>三、双方义务权利</p>
				<p>甲方：</p>
				...
				<p>　<span class="text_1">
						<?php if($list->xy_qz == '1'): ?>
							甲方已签认
						<?php elseif($list->xy_qz == '2'): ?>
							系统代签
						<?php else: ?>
							甲方（签字）
						<?php endif; ?></span>：<span class="btn btn_1">签认按钮</span> 
