...
<html>
    <head>
        <meta charset="UTF-8">
        <title>【栗志家教】<?php echo $__env->yieldContent('title'); ?>家教_专业大学生家教全国连锁领导品牌!</title>
        ...
        <meta name="keywords" content="栗志家教,<?php echo e(mb_substr(session('regionname'),0,2)); ?>家教,<?php echo e(mb_substr(session('regionname'),0,2)); ?>家教网,<?php echo e(mb_substr(session('regionname'),0,2)); ?>大学生家教,<?php echo e(mb_substr(session('regionname'),0,2)); ?>家教,<?php echo e(mb_substr(session('regionname'),0,2)); ?>家教网,辅导,补习,一对一" />
        <link href="/home/css/style.css" rel="stylesheet" type="text/css" />
        <link href="/delijiajiao/css/style1.css" rel="stylesheet" type="text/css" />
...
<div id="header">
    <div class="header-top">
        <div class="container">
            ...
            <?php else: ?>
                <div class="left pull-left">
                    <?php echo e(substr(Session('tc_name'),0,3)); ?>教员您好!<a href="/teacherinfo.html" class="login">个人中心</a>
    ...
    <div class="city pull-right"><span><?php echo e(mb_substr(session('regionname'),0,2)); ?></span>
        <div class="city-down">
            <ul id="zz">
                            ...
                            <?php $__currentLoopData = $yiji; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <dl style="width:200px;overflow: hidden;height: 38px;">
                                        <dt><?php echo e($yj->yiji); ?></dt>

                                        <a><?php echo e($yj->introduce); ?></a>
                                                    ...
                                                    <dd>
                                                        <?php $__currentLoopData = $sanji; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($ej->id == $sj->erji_id): ?>
                                                                <a href="/l-c1-a1-n332/"><?php echo e($sj->sanji); ?></a>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </dd>
                                                </dl>
