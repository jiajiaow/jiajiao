		...
		<!--nav 开始 -->
			<div class="cheng_1body" style="width:954px;">
                            <div class="zqm_xy">
                                ...
                                <div class="a2"><p><?php echo e($user->name); ?></p><span>您好，欢迎您来到个人中心</span></div>
                                <div class="zqm_a1">
                                    <form action="" method="post">
                                    <div class="yh"> <label>帐　　号</label>
                                    <input type="text" name="fname" placeholder="您的帐号" value="<?php echo e($user->phone); ?>" /></div>
                                    <div class="div5"></div>
                                    ...
                                    <input type="text" name="fname" placeholder="请输入联系人电话" value="<?php echo e($user->phone); ?>"/></div>
                                    <div class="div5"></div>
                                    <div class="yh"><label>备用电话１</label>
                                    <input type="text" name="lname" placeholder="备用电话" value="<?php echo e($user->phone2); ?>" /><div class="txt">点击编辑备用电话，也将收到教学信息</div></div>
                                    <div class="div5"></div>
                                    <div class="yh"><label>备用电话２</label>
                                    <input type="text" name="lname" placeholder="备用电话" value="<?php echo e($user->phone3); ?>" /><div class="txt">点击编辑备用电话，也将收到教学信息</div></div>
                                    <div class="div5"></div>
