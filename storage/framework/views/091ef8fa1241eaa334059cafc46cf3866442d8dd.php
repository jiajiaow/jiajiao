                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="gradeX">
                                <td class="center"><?php echo e($lis->ar_id); ?></td>
                                <td><?php echo e($lis->dh_Navigationbar); ?></td>
                                <td><?php echo e($lis->ar_title); ?></td>
                                <td class="center" style="color:<?php echo e($lis->ar_status==1?'red':'#646464'); ?>;"><?php echo e($lis->ar_status==1?'顶':'否'); ?></td>
                                <td class="center">
                                    <a href="/admin/wzmodify<?php echo e($lis->ar_id); ?>">编辑</a>  |
                                    <a href="/admin/wzde/<?php echo e($lis->ar_id); ?>" >删除</a>
                                </td>
                            </tr>
