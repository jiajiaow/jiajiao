                         ...
                         <?php if($jp->tc_jinpai == 2): ?>
                            <li class="kuan">
                                <div class="top">
                                    ...
                                    <i><?php echo e(substr($jp->tc_name,0,3)); ?>教员</i>
                                    <span>
                                        <img src="/home/picture/icon_imperial.png" alt="<?php echo e($jp->tc_name); ?>">
                                    </span>
                                    <div class="hover">
                                        <p><?php echo e($jp->tc_case); ?>.</p>
                                        <a href="javascript:void(0)" onclick="location.href='/teacher/detail/<?php echo e($jp->id); ?>.html'" class="look">查看 ></a>
                                    </div>
                                </div>
                                <div class="bottom">
                                        
                                        
                                    <a href=""><?php echo e($jp->tc_school); ?></a>
                                    <div class="clear"></div>
                                    <a href="javascript:void(0);" onclick="writeCookie(<?php echo e($jp->id); ?>);yuyueCookie();" class="btn">预约免费试课</a>
                                </div>
                            </li>
                        <?php endif; ?>
                ...
                <div class="tabcont" id="centermin">
                    <div class="active tabbox">
                        ...
                        <?php $__currentLoopData = $jy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $xs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li >
                                <div class="top">
                                    <img src="/home/images/logo.png" alt="<?php echo e($xs->tc_name); ?>" width="110" height="110">
                                    <i><?php echo e(substr($xs->tc_name,0,3)); ?>教员</i>
                                </div>
                                <div class="bottom">
                                    <a href=""><?php echo e($xs->tc_type); ?></a>
                                    <br/>
                                    <a href=""><?php echo e($xs->tc_school); ?></a>
                                    <div class="clear"></div>
                                    <a href="javascript:void(0);" onclick="writeCookie(<?php echo e($xs->id); ?>);yuyueCookie();" class="btn">预约免费试课</a>
                                </div>
                            </li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="tabcont" id="centermin">
                    <div class="active tabbox">
                        ...
                        <?php $__currentLoopData = $jy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li >
                                <div class="top">
                                    <img src="/home/images/logo.png" alt="<?php echo e($zz->tc_name); ?>" width="110" height="110">
                                    <i><?php echo e($zz->tc_name); ?></i>
                                </div>
                                <div class="bottom">
                                    <a href=""><?php echo e($zz->tc_type); ?></a>
                                    <br/>
                                    <a href=""><?php echo e($zz->tc_school); ?></a>
                                    <div class="clear"></div>
                                    <a href="javascript:void(0);" onclick="writeCookie(<?php echo e($zz->id); ?>);yuyueCookie();" class="btn">预约免费试课2</a>
                                </div>
                            </li>
