        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" action="<?php echo e(asset('/admin/dosanji')); ?>" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b" id="cid"  name='erji'>
                                    <option value="-1">请选择二级分类别</option>
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lis->id); ?>">--&nbsp;&nbsp;<?php echo e($lis->erji); ?>&nbsp;&nbsp;--</option>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">填写三级分类</label>
                            <div class="col-sm-10">
                                <input type="text" name="sanji" placeholder="请输入三级分类：例：高一二三语文,钢琴,素描等" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
