				...
				<div class="ddh-one">
					...
					<div id="xxx" style="display:none">
						...
						<div class="d-h" id='caozz'>
							...
							<label>信息费：</label>
							<input name="money"  class="d-jine"  value="<?php echo e($data['xxf']); ?>" >
							<input type="hidden" name="order_id"  class="d-jine"  value="<?php echo e($data['order_id']); ?>" >
						</div>
					</div>
					<!--  -->
