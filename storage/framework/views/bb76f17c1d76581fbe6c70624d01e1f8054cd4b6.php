		...
		<!--nav 开始 中间主体-->
			<div class="cheng_body" style="width:954px;">
				...
				<div class="cai_top">
					<div class="cai-one">
						<h5>账户余额</h5>
						<span class='span-one'><?php echo e($list->tc_money); ?></span>
						<br/>
				...
				<div class="cai-mid">
							<div class="cai-mid-one">
								<div>
									<label>支付宝:</label>
									<span><?php echo e($list->tc_pay_zfb); ?></span>
								</div>
								<div>
									<label>微信:</label>
									<span><?php echo e($list->tc_wechat); ?></span>
								</div>
							</div>
							<div class="cai-mid-two">
								<div>
									<label>开户银行:</label>
									<span><?php echo e($list->tc_pay_yh); ?></span>
								</div>
								<div>
									<label>开户账号:</label>
									<span><?php echo e($list->tc_yh_account); ?></span>
								</div>
							</div>
						</div>
				<!-- 收支流水 -->
