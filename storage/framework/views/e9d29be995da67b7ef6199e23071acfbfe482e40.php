                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="gradeX">
                                ...
                                <td><?php echo e($lis->school_name); ?></td>
                                <td><?php echo e($lis->region); ?></td>
                                <td class="center">
                                ...
                                <td class="center">
                                 ...
                                 <?php if($lis->hot == 1): ?>
                                        <a href="/admin/do_hot_school/<?php echo e($lis->id); ?>/0" class="glyphicon glyphicon-ok">取消</a>
                                    <?php else: ?>
                                        <a href="/admin/do_hot_school/<?php echo e($lis->id); ?>/1" class="glyphicon glyphicon-remove">设置热门</a>
                                    <?php endif; ?>
