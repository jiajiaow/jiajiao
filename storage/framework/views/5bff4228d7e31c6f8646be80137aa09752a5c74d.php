                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="gradeX">
                                ...
                                <td><?php echo e($lis->tc_name); ?></td>
                                <td><?php echo e($lis->city_name); ?></td>
                                <td class="center">
                                    <?php if($lis->tc_sort == 1 && $lis->tc_jinpai == 2): ?>
                                        前台显示
                                    <?php else: ?>
                                        前台没显示
                                    <?php endif; ?>
                                ...
                                <td class="center">
                                    ...
                                    <?php if($lis->tc_sort == 1): ?>
                                        <a href="/admin/do_xue_sheng/<?php echo e($lis->id); ?>/0" class="glyphicon glyphicon-ok">取消</a>
                                    <?php else: ?>
                                        <a href="/admin/do_xue_sheng/<?php echo e($lis->id); ?>/1" class="glyphicon glyphicon-remove">设置显示</a>
                                    <?php endif; ?>
...
<script>
    ...
    function aa(id){
        //alert(id);
        window.location.href ="/admin/xuesheng/"+id;
