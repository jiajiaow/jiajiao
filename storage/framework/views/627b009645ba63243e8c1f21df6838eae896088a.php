    ...
    <div class="com_content_box">
        <div class="my_details_box">
            <div class="my_details_top">
                <div class="mdt_ava">
                    <img src="<?php echo e($list->tc_photo); ?>" alt="" style="width:2.3rem;">
                </div>
                <div class="mdt_msg">
                    <p class="mdtm_name"><?php echo e($list->tc_name); ?>教员<span class="mdym_num">T<?php echo e($list->id); ?></span></p>
                    <p class="mdtm_phone">手机号：<?php echo e($list->tc_phone); ?></p>
                    <p class="mdtm_see">
                        <span>
                            <i class="my_id icon"></i>
                            <span><?php echo e($list->tc_audit=='0'?"身份未验证":"身份已验证"); ?></span>
                            <i class="my_doubt "></i>
                        </span>
            ...
            <div class="my_details_bottom">
                <ul class="my_details_bottom_ul">
                    ...
                    <li>
                        <p><?php if($list->tc_jinpai =='2'): ?>金牌教员<?php elseif($list->tc_jinpai=='1'): ?>专职教员<?php else: ?>学生教员<?php endif; ?></p>
                        <p>教员等级</p>
                    </li>
                </ul>
            </div>
