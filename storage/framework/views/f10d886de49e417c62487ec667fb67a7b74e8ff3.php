            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo e(asset('/admin/dodhedit')); ?>" class="form-horizontal" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="erji" placeholder="请输入分类名：" value="<?php echo e($lis->erji); ?>" class="form-control">
                                        <input type="hidden" name="id" placeholder="请输入分类名：" value="<?php echo e($lis->id); ?>" class="form-control">
                                        <input type="hidden" name="fl"  value="-20" class="form-control">
