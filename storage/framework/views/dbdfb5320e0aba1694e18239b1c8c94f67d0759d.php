                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="gradeX">
                                ...
                                <td><?php echo e($lis->m_pay_money); ?></td>
                                <td><?php echo e($lis->m_mtype); ?></td>
                                <td><?php echo e(date("Y-m-d h:i:s",$lis->m_time)=='1970-01-01 08:00:00'?'':date("Y-m-d h:i:s",$lis->m_time)); ?></td>
                                <td class="center">
