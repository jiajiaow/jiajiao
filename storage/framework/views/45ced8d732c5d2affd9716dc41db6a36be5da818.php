            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo e(asset('/admin/goodsbjdo')); ?>" class="form-horizontal" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" name="gs_id" value="<?php echo e($data->gs_id); ?>"/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">商品名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="gs_name" placeholder="" value="<?php echo e($data->gs_name); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="gs_price" value="<?php echo e($data->gs_price); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="gs_yprice" value="<?php echo e($data->gs_yprice); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                <!-- 加载编辑器的容器 -->
                                <script id="container" name="gs_content" type="text/plain"><?php echo $data->gs_content; ?></script>
