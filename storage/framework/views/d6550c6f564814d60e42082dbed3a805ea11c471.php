                            ...
                            <tr class="gradeX">
                                ...
                                <td class="center">
                                    ...
                                    <?php if($lis->tc_sort == 1): ?>
                                        <a href="/admin/do_zhuan_zhi/<?php echo e($lis->id); ?>/0" class="glyphicon glyphicon-ok">取消</a>
                                    <?php else: ?>
                                        <a href="/admin/do_zhuan_zhi/<?php echo e($lis->id); ?>/1" class="glyphicon glyphicon-remove">设置显示</a>
                                    <?php endif; ?>
...
<script>
    ...
    function aa(id){
        //alert(id);
        window.location.href ="/admin/zhuanzhi/"+id;
