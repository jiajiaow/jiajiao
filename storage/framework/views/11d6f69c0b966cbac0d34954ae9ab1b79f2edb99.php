            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo e(asset('/admin/dotjbs')); ?>" class="form-horizontal" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">添加一级分类</label>
                                <div class="col-sm-10">
                                    <input type="text" name="biaoshi" placeholder="请输入一级分类：例：高中,初中,小学,语言,其他,艺术" class="form-control">
                                </div>
                            </div>
