	...
	<form method="post" action="/doxy_hetong">
		<div class="wrap">
			...
			<div class="content-mid">
				...
				<p>　<span class="text_1"><?php if($list->jy_qz == '1'): ?> 甲方已签认 <?php else: ?>甲方（签字）<?php endif; ?></span>：<button class="btn btn_1">签认按钮</button> <span class="text_2">乙方签字</span>：<span class=" btn_2">已签认</span>  <span class="text_3"><?php if($list->jy_qz == '1'): ?> 丙方已签认 <?php else: ?>丙方（签字）<?php endif; ?></span>：<span class="btn btn_3">签认按钮</span></p>
